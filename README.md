...
| **Dataset / Benchmark**                              | **Year** | **Size (Scale)** | **Input Modality** | **Key Annotations for LWMs**    | **Supported Evaluation**   |
| :--------------------------------------------------- | :------- | :--------------- | :----------------- | :------------------------------ | :------------------------- |
| ***I. Foundation Datasets for Dynamics Learning***   |          |                  |                    |                                 |                            |
| [**nuScenes**](https://arxiv.org/pdf/1903.11027)     | 2020     | 40K frames       | Cam, LiDAR, Rad    | 3D BBox, Map, Ego-pose          | Open-loop Planning         |
| [**Waymo Open**](https://arxiv.org/pdf/1912.04838)   | 2020     | 104K frames      | Cam, LiDAR         | 3D BBox, Map, High-freq Traj.   | Open-loop Planning         |
| [**Argoverse 2**](https://arxiv.org/pdf/2301.00493)  | 2023     | 250K logs        | Cam, LiDAR         | HD Map, Multi-agent Traj.       | Open-loop Planning         |
| [**WOMD-E2E**](https://arxiv.org/pdf/2104.10133)     | 2024     | 4,021 clips      | Cam, LiDAR         | Multi-agent Traj., Ego-action   | Reactive Closed-loop       |
| ***II. Large-Scale Video Pre-training Corpus***      |          |                  |                    |                                 |                            |
| [**OpenDV-2K**](https://arxiv.org/pdf/2403.03182)    | 2024     | 65.1M frames     | Camera-only        | Ego-trajectory (Pseudo)         | Latent Representation      |
| [**BDD100K**](https://arxiv.org/pdf/1805.04687)      | 2020     | 100K videos      | Camera-only        | 2D Box, Action (Lane/Turn)      | Domain Adaptation          |
| [**SHIFT**](https://arxiv.org/pdf/2206.08347)        | 2022     | 5M frames        | Multi-modal        | Dense Depth, Segmentation       | Domain Adaptation          |
| [**DrivePhysica**](https://arxiv.org/pdf/2412.08410) | 2024     | 10M frames       | Camera-only        | Unannotated physics evolution   | Video Pre-training         |
| ***III. Closed-Loop Planning & Decision Making***    |          |                  |                    |                                 |                            |
| [**nuPlan**](https://arxiv.org/pdf/2106.11810)       | 2021     | 1,500 hours      | Cam, LiDAR, Map    | Human Driving Traj., Ego-action | Reactive Closed-loop       |
| [**Bench2Drive**](https://arxiv.org/pdf/2406.03877)  | 2024     | 10K clips        | Multi-modal        | Dense Action, Ego-state         | CARLA Closed-loop          |
| [**NAVSIM**](https://arxiv.org/pdf/2406.15349)       | 2024     | 1M+ frames       | Cam, LiDAR         | Action-trajectory alignment     | Non-reactive Closed-loop   |
| ***IV. Reasoning & Instruction Following (VLA)***    |          |                  |                    |                                 |                            |
| [**DriveLM**](https://arxiv.org/pdf/2312.14150)      | 2024     | 445K QA pairs    | Cam, LiDAR         | Graph QA, Logical reasoning     | Instruction Fidelity       |
| [**LMDrive**](https://arxiv.org/pdf/2312.07488)      | 2024     | 120K traj.       | Camera, Text       | Navigation Prompts, Action      | Language-guided Control    |
| [**Rank2Tell**](https://arxiv.org/pdf/2309.01428)    | 2024     | 50K traj.        | Cam, LiDAR         | Importance ranking, Ego-action  | Reasoning Interpretability |
| [**AutoVLA**](https://arxiv.org/pdf/2506.13757)      | 2024     | 80K episodes     | Multi-modal        | Multimodal QAs, Policy steps    | VLA Reasoning              |
...
| **Category / Metric**                                        | **Dir.** | **Definition / Mathematical Form**                           | **Target Capability Evaluated** |
| :----------------------------------------------------------- | :------: | :----------------------------------------------------------- | :------------------------------ |
| <br>***Latent Representation Quality***                      |          |                                                              |                                 |
| [**Linear Probing (LP-mIoU/mAP)**](https://arxiv.org/pdf/2402.11502) |    ↑     | Accuracy of frozen encoder on downstream tasks               | Semantic Disentanglement        |
| [**Latent Prediction Error (LPE)**](https://arxiv.org/pdf/2210.13877) |    ↓     | $\Vert z_{t+1} - \hat{z}_{t+1}\Vert_2^2$ or $1 - \cos(z_{t+1}, \hat{z}_{t+1})$ | Dynamics Consistency            |
| [**Long-Horizon Consistency (LHC)**](https://arxiv.org/pdf/2210.13877) |    ↑     | Error decay rate over unrolled multi-step predictions        | Temporal Stability              |
| [**Disentanglement Score (DS)**](https://arxiv.org/pdf/2312.07488) |    ↑     | InfoNCE loss measuring action-environment independence       | Action-Conditioned Fidelity     |
| [**Temporal Consistency (TCS)**](https://arxiv.org/pdf/2309.09777) |    ↑     | Variance of latent state transitions across adjacent frames  | Motion Smoothness               |
| [**Normalized Mutual Info. (NMI)**](https://arxiv.org/pdf/2312.14150) |    ↑     | Mutual information between latent clusters and labels        | Feature Interpretability        |
| [**Feature-level LPIPS (LPIPS-F)**](https://arxiv.org/pdf/2309.09777) |    ↓     | Perceptual similarity calculated purely in feature space     | Perceptual Preservation         |
| <br>***Open-Loop Planning***                                 |          |                                                              |                                 |
| [**Avg. / Final Disp. Error (ADE/FDE)**](https://arxiv.org/pdf/1903.11027) |    ↓     | $\frac{1}{T} \sum \Vert p_t - \hat{p}_t\Vert_2$ (ADE) and $\Vert p_T - \hat{p}_T\Vert_2$ (FDE) | Trajectory Accuracy             |
| [**Collision Rate (CR)**](https://arxiv.org/pdf/2106.11810)  |    ↓     | Percentage of predicted trajectories intersecting obstacles  | Spatial Safety Awareness        |
| [**Miss Rate (MR)**](https://arxiv.org/pdf/2106.11810)       |    ↓     | Rate that ground-truth is not covered by predictions         | Scenario Coverage               |
| [**Predictive Driver Score (PDMS)**](https://arxiv.org/pdf/2406.15349) |    ↑     | Consistency of predicted behavior with human patterns        | Human-like Interaction          |
| <br>***Closed-Loop Simulation & Reasoning***                 |          |                                                              |                                 |
| [**Driving Score (DS)**](https://arxiv.org/pdf/1711.03938)   |    ↑     | $\text{Route Completion} \times (1 - \text{Infraction Penalty})$ | Comprehensive Policy            |
| [**Success Rate (SR)**](https://arxiv.org/pdf/1711.03938)    |    ↑     | Percentage of episodes completed without collision           | Safe Navigation Limit           |
| [**Infraction Score (IS)**](https://arxiv.org/pdf/1711.03938) |    ↓     | Cumulative penalty from traffic rule violations              | Long-tail Safety                |
| [**Route Completion (RC)**](https://arxiv.org/pdf/1711.03938) |    ↑     | Percentage of planned route distance successfully traversed  | Goal-directed execution         |
| [**Instruction Fidelity (IF)**](https://arxiv.org/pdf/2312.07488) |    ↑     | Execution alignment with natural language prompts            | LLM-guided Control              |
| [**Reasoning Interpretability (RI)**](https://arxiv.org/pdf/2309.01428) |    ↑     | Consistency of Chain-of-Thought output with human logic      | Action Explainability           |
