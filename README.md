...
| [**UnO**](https://openaccess.thecvf.com/content/CVPR2024/papers/Agro_UnO_Unsupervised_Occupancy_Fields_for_Perception_and_Forecasting_CVPR_2024_paper.pdf) | Continuous 4D Field                        | Neural ODE / 4D Func           | Occupancy Prob                 | Querying 4D Field       |                              x                               |
...
| [**CarFormer**](https://arxiv.org/pdf/2407.15843)            | Implicit Object Slots                      | Autoregressive Trans.          | Trajectory Alignment           | Slot Attention Decoding |       [GitHub](https://github.com/Shamdan17/CarFormer)       |
| [**Wayformer**](https://arxiv.org/pdf/2207.05844)            | Scene Tokens                               | Multi-axis Attention           | Trajectory Alignment           | Scene-centric Decoding  |                              x                               |
| [**Forecast-MAE**](https://arxiv.org/pdf/2308.09882)         | Trajectory Context Tokens                  | Masked Autoencoder             | Trajectory Recon.              | Mask-Predict Decoding   |      [GitHub](https://github.com/jchengai/forecast-mae)      |
...
| [**nuScenes**](https://arxiv.org/pdf/1903.11027)       | 2020     | 40K frames       | Cam, LiDAR, Rad    | 3D BBox, Map, Ego-pose          | Open-loop Planning         |            [Homepage](https://www.nuscenes.org/)             |
| [**Waymo Open**](https://arxiv.org/pdf/1912.04838)     | 2020     | 104K frames      | Cam, LiDAR         | 3D BBox, Map, High-freq Traj.   | Open-loop Planning         |              [Homepage](https://waymo.com/open)              |
| [**Argoverse 2**](https://arxiv.org/pdf/2301.00493)    | 2023     | 250K logs        | Cam, LiDAR         | HD Map, Multi-agent Traj.       | Open-loop Planning         |            [Homepage](https://www.argoverse.org/)            |
...
| [**BDD100K**](https://arxiv.org/pdf/1805.04687)        | 2020     | 100K videos      | Camera-only        | 2D Box, Action (Lane/Turn)      | Domain Adaptation          |          [Homepage](https://bdd-data.berkeley.edu/)          |
| [**SHIFT**](https://arxiv.org/pdf/2206.08347)          | 2022     | 5M frames        | Multi-modal        | Dense Depth, Segmentation       | Domain Adaptation          |            [Homepage](https://www.vis.xyz/shift/)            |
| [**DrivePhysica**](https://arxiv.org/pdf/2412.08410)   | 2024     | 10M frames       | Camera-only        | Unannotated physics evolution   | Video Pre-training         | [Homepage](https://metadrivescape.github.io/papers_project/DrivePhysica/page.html) |
| <br>***III. Closed-Loop Planning & Decision Making***  |          |                  |                    |                                 |                            |                                                              |
| [**nuPlan**](https://arxiv.org/pdf/2106.11810)         | 2021     | 1,500 hours      | Cam, LiDAR, Map    | Human Driving Traj., Ego-action | Reactive Closed-loop       |                [Homepage](https://nuplan.org)                |
...
| [**Avg. / Final Disp. Error (ADE/FDE)**](https://arxiv.org/pdf/1903.11027) |    ↓     | $\frac{1}{T} \sum \Vert p_t - \hat{p}_t\Vert_2$ (ADE) and $\Vert p_T - \hat{p}_T\Vert_2$ (FDE) | Trajectory Accuracy             |          [Homepage](https://www.nuscenes.org/)          |
| [**Collision Rate (CR)**](https://arxiv.org/pdf/2106.11810)  |    ↓     | Percentage of predicted trajectories intersecting obstacles  | Spatial Safety Awareness        |             [Homepage](https://nuplan.org)              |
| [**Miss Rate (MR)**](https://arxiv.org/pdf/2106.11810)       |    ↓     | Rate that ground-truth is not covered by predictions         | Scenario Coverage               |             [Homepage](https://nuplan.org)              |
...
| [**Driving Score (DS)**](https://arxiv.org/pdf/1711.03938)   |    ↑     | $\text{Route Completion} \times (1 - \text{Infraction Penalty})$ | Comprehensive Policy            |             [Homepage](https://carla.org/)              |
| [**Success Rate (SR)**](https://arxiv.org/pdf/1711.03938)    |    ↑     | Percentage of episodes completed without collision           | Safe Navigation Limit           |             [Homepage](https://carla.org/)              |
| [**Infraction Score (IS)**](https://arxiv.org/pdf/1711.03938) |    ↓     | Cumulative penalty from traffic rule violations              | Long-tail Safety                |             [Homepage](https://carla.org/)              |
| [**Route Completion (RC)**](https://arxiv.org/pdf/1711.03938) |    ↑     | Percentage of planned route distance successfully traversed  | Goal-directed execution         |             [Homepage](https://carla.org/)              |
